...
dependency "batch" {
  ...
  mock_outputs = {
    job_definition_arn  = "arn:aws:batch:us-east-1:012345678901:job-definition/agent-arn"
...
dependency "ecr" {
  ...
  mock_outputs = {
    ...
    ecr_repository_arn = "arn:aws:ecr:us-east-1:012345678901:repository/agent-repository"
  }
}
